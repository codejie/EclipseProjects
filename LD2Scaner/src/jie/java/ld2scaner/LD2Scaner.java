...
public class LD2Scaner {
	...
	private static final String[] ld2File = new String[] { "./data/Vicon Chinese(S)-English Dictionary.ld2" };
//	private final static String ld2File = "./data/Essential English Dictionary.ld2";
	public static void main(String[] args) {
		
		DBHelper db = DBHelper.create("./data/db.db");
		
		for(int i = 0; i < ld2File.length; ++ i) {
			if(FileScan.scan(ld2File[i], db) != 0) {
